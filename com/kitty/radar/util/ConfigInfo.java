...
//                RadarBase.level = Float.parseFloat(props.getProperty("level"));
                ...
                RadarParams.userId=props.getProperty("user.id");
                RadarParams.pw=props.getProperty("pw");
                RadarParams.downloadradarstationid= props.getProperty("download.radar.station.id");
                RadarParams.radarSavePath=props.getProperty("radar.save.path");
...
//            props.setProperty("level", String.valueOf(RadarBase.level));
            ...
            props.setProperty("radar.save.path", RadarParams.radarSavePath);
            props.setProperty("user.id", RadarParams.userId);
            props.setProperty("pw", RadarParams.pw);
            props.setProperty("download.radar.station.id",  RadarParams.downloadradarstationid);
