...
public class RectangleHandler extends AreaHandler {
    ...
    public RectangleHandler(AreaInputDialog dialog, ValidationGroup group, Area area) {
        this.dialog = dialog;
        this.group = group;
        ...
        label = dialog.mainPanel.addLabel("长度", 40, 126);
        ...
        label = dialog.mainPanel.addLabel("宽度", 40, 158);
        ...
        if (area != null && area instanceof RectangleArea) {
            RectangleArea ra = (RectangleArea) area;
    ...
    public void process(ActionEvent e) {
        ...
        if (p == null) {
            RectangleArea rect = new RectangleArea(Double.parseDouble(lng.getText()), Double
