...
public abstract class AbstractMapExt<K, V> implements Map<K, V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMapExt() {
    }
    ...
    public Set<K> keySet() {
        if (keySet == null) {
            keySet = new AbstractSet<K>() {
                ...
                public int size() {
                    return AbstractMapExt.this.size();
                }

                public boolean contains(Object k) {
                    return AbstractMapExt.this.containsKey(k);
                }
            };
        }
        return keySet;
        ...
        if (values == null) {
            values = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return AbstractMapExt.this.containsValue(v);
                }
            };
        }
        return values;
    ...
    protected Object clone() throws CloneNotSupportedException {
        AbstractMapExt<K, V> result = (AbstractMapExt<K, V>) super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
